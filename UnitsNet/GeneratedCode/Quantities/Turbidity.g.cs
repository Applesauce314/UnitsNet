...
namespace UnitsNet
{
    ...
    public readonly partial struct Turbidity :
        ...
        IEquatableQuantity<Turbidity, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Turbidity, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is Turbidity otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
