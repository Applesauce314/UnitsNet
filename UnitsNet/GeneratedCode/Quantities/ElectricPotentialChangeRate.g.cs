...
namespace UnitsNet
{
    ...
    public readonly partial struct ElectricPotentialChangeRate :
        ...
        IEquatableQuantity<ElectricPotentialChangeRate, double>,
        IFormattable
    {
        /// <summary>
        ...
        {
            return other is ElectricPotentialChangeRate otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
