...
namespace UnitsNet
{
    ...
    public readonly partial struct Permittivity :
        ...
        IEquatableQuantity<Permittivity, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Permittivity, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is Permittivity otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
