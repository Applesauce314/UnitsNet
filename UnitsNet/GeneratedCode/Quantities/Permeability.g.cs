...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        /// <remarks>Consider using <see cref="Equals(Permeability, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is Permeability otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
