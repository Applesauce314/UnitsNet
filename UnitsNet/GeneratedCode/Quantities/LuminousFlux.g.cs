...
namespace UnitsNet
{
    ...
    public readonly partial struct LuminousFlux :
        ...
        IEquatableQuantity<LuminousFlux, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(LuminousFlux, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is LuminousFlux otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
