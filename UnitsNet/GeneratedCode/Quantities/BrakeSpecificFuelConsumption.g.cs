...
namespace UnitsNet
{
    ...
    public readonly partial struct BrakeSpecificFuelConsumption :
        ...
        IEquatableQuantity<BrakeSpecificFuelConsumption, double>,
        IFormattable
    {
        /// <summary>
        ...
        {
            return other is BrakeSpecificFuelConsumption otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
