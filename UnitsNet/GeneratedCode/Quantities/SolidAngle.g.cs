...
namespace UnitsNet
{
    ...
    public readonly partial struct SolidAngle :
        ...
        IEquatableQuantity<SolidAngle, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(SolidAngle, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is SolidAngle otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
