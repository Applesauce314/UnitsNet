...
namespace UnitsNet
{
    ...
    public readonly partial struct MolarEnergy :
        ...
        IEquatableQuantity<MolarEnergy, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(MolarEnergy, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is MolarEnergy otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
