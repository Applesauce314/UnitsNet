...
namespace UnitsNet
{
    ...
    public readonly partial struct ReactiveEnergy :
        ...
        IEquatableQuantity<ReactiveEnergy, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(ReactiveEnergy, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is ReactiveEnergy otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
