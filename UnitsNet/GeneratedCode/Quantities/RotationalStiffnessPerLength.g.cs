...
namespace UnitsNet
{
    ...
    public readonly partial struct RotationalStiffnessPerLength :
        ...
        IEquatableQuantity<RotationalStiffnessPerLength, double>,
        IFormattable
    {
        /// <summary>
        ...
        {
            return other is RotationalStiffnessPerLength otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
