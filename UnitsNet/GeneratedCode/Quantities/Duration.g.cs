...
namespace UnitsNet
{
    ...
    public readonly partial struct Duration :
        ...
        IConvertible,
        IEquatable<Duration>,
        IEquatableQuantity<Duration, double>,
        IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Duration, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        ...
        {
            return other is Duration otherTyped && Equals(otherTyped, tolerance, comparisonType);
        }
